...
public class BillingIntegrationTest extends BaseIntegrationTest {
    ...
    void testInvoiceCreation() throws Exception {
        ...
        Map<String, Object> prodData = objectMapper.readValue(
        ...
        mockMvc
                .perform(
                        post("/api/v1/tenant/stock/in")
                                ...
                                .content(
                                        String.format(
                                                "{\"productId\": %d, \"quantity\": 10, \"notes\": \"Stock for billing test\"}",
                                                productId)))
                .andDo(print())
        ...
        Map<String, Object> custData = objectMapper.readValue(
