...
public class BillingIntegrationTest extends BaseIntegrationTest {
    ...
    @Autowired
    private com.ims.tenant.repository.CustomerRepository customerRepository;
    ...
    void testInvoiceGenerationAndPdfDownload() throws Exception {
        ...
        Long tenantId = Objects
                .requireNonNull(tenantRepository.findByWorkspaceSlug("billing-corp").orElseThrow().getId());
        String token2 = login("admin@billing.com", "password123", Objects.requireNonNull(response.getCompanyCode()),
                tenantId);
