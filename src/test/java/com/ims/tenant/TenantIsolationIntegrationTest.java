...
class TenantIsolationIntegrationTest extends BaseIntegrationTest {
    ...
    void tenantContextIsIsolated() throws Exception {
        ...
        MockHttpServletRequestBuilder getTenant1Builder = get("/api/tenant/settings").header("Authorization",
                "Bearer " + tenant1Token);
        mockMvc
        ...
        MockHttpServletRequestBuilder getTenant2Builder = get("/api/tenant/settings").header("Authorization",
                "Bearer " + tenant2Token);
        mockMvc
