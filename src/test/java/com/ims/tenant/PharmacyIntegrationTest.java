...
public class PharmacyIntegrationTest extends BaseIntegrationTest {
    ...
    void testPharmacyProductFlow() throws Exception {
        ...
        String token = login("admin@pharmacy.com", "password123", Objects.requireNonNull(response.getCompanyCode()),
                tId);
    ...
    void testExpiredProductInclusion() throws Exception {
        ...
        String token = login("admin@expired.com", "password123", Objects.requireNonNull(response.getCompanyCode()),
                tId);
    ...
    void testMandatoryPharmacyFields() throws Exception {
        ...
        String token = login("admin@missing.com", "password123", Objects.requireNonNull(response.getCompanyCode()),
                tId);
