...
public abstract class BasePlaywrightTest {
    ...
    static {
        ...
        String frontendUrl = System.getProperty("frontendUrl",
                "https://inventory-management-frontend-r3amqhnaf.vercel.app/");
    ...
    private static void startFrontend() {
        ...
        if (frontendDir.exists()) {
            ...
            System.err.println("COULD NOT FIND FRONTEND DIRECTORY. Please start manually: cd frontend && npm run dev");
        }
    }
    ...
    protected String baseUrl() {
        ...
        String frontendUrl = System.getProperty("frontendUrl",
                "https://inventory-management-frontend-r3amqhnaf.vercel.app/");
        System.out.println("Using base URL for UI tests: " + frontendUrl + " (Backend is on port " + port + ")");
        return frontendUrl;
    }
