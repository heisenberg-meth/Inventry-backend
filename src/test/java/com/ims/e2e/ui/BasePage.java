...
public abstract class BasePage {
    ...
    public void navigate(String baseUrl) {
        ...
        System.out.println(
                "Page Content Preview: " + page.content().substring(0, Math.min(500, page.content().length())));

        Path screenshotPath = Paths
                .get("target/debug-screenshots/" + this.getClass().getSimpleName() + ".png");
    ...
    protected void fill(Locator locator, String text) {
        ...
        System.out.println(
                "PAGE CONTENT PREVIEW: " + page.content().substring(0, Math.min(1000, page.content().length())));
