...
class CustomerServiceUnitTest {
  ...
  void getCustomers_returnsPagedResults() {
    Customer customer = Customer.builder().id(1L).name("Test Customer").tenantId(1L).build();
  ...
  void create_withValidData_createsCustomer() {
    Customer customer = Customer.builder().name("New Customer").phone("1234567890").build();
  ...
  void delete_existingCustomer_deletesSuccessfully() {
    Customer customer = Customer.builder().id(1L).tenantId(1L).build();
