...
public class OrderManagementIntegrationTest extends BaseIntegrationTest {
    ...
    void setUp() {
        ...
        // Create Inventory
        Inventory inventory = Inventory.builder().tenantId(testTenant1Id).productId(productId).quantity(10).build();
    ...
    void testCreateSaleOrderSuccess() {
        ...
        OrderResponse response = orderService.createSalesOrder(testTenant1Id, request, testUserId);
    ...
    void testCreateSaleOrderInsufficientStock() {
        ...
        assertThrows(
                ...
                () -> orderService.createSalesOrder(testTenant1Id, request, testUserId));
    ...
    void testCreatePurchaseOrderSuccess() {
        ...
        OrderResponse response = orderService.createPurchaseOrder(testTenant1Id, request, testUserId);
        ...
        // Complete the order
        orderService.completeOrder(response.getId(), testTenant1Id, testUserId);
    ...
    void testTenantIsolation() {
        ...
        assertThrows(
                ...
                () -> orderService.createSalesOrder(testTenant2Id, request, testUserId));
    }
}
