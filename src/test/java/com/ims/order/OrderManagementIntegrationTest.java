...
public class OrderManagementIntegrationTest extends BaseIntegrationTest {
        ...
        void testCreateSaleOrderSuccess() {
                ...
                assertEquals(10, inventoryRepository.findByProductIdAndTenantId(productId, testTenant1Id).get()
                                .getQuantity());
                ...
                assertEquals(8, inventoryRepository.findByProductIdAndTenantId(productId, testTenant1Id).get()
                                .getQuantity());
        ...
        void testCreatePurchaseOrderSuccess() {
                ...
                assertEquals(15, inventoryRepository.findByProductIdAndTenantId(productId, testTenant1Id).get()
                                .getQuantity());
