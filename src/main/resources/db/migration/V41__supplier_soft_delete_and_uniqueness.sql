...
CREATE UNIQUE INDEX IF NOT EXISTS ux_suppliers_tenant_email ON suppliers (tenant_id, email)
WHERE is_deleted = false;
CREATE UNIQUE INDEX IF NOT EXISTS ux_suppliers_tenant_phone ON suppliers (tenant_id, phone)
WHERE is_deleted = false;
