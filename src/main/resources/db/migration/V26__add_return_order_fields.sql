...
ALTER TABLE orders ADD COLUMN IF NOT EXISTS reference_order_id BIGINT REFERENCES orders(id);

-- Add parent_invoice_id to invoices for credit notes
ALTER TABLE invoices ADD COLUMN IF NOT EXISTS parent_invoice_id BIGINT REFERENCES invoices(id);
