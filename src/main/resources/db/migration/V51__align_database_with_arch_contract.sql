...
INSERT INTO inventory (tenant_id, product_id, quantity, reorder_level, created_at, updated_at)
SELECT tenant_id, id, stock, reorder_level, created_at, updated_at FROM products;
...
ALTER TABLE audit_logs RENAME COLUMN old_value TO before_value;
ALTER TABLE audit_logs RENAME COLUMN new_value TO after_value;
