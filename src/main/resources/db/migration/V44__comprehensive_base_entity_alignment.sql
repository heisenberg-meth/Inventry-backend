...
ALTER TABLE transfer_orders ADD COLUMN IF NOT EXISTS version BIGINT DEFAULT 0;
ALTER TABLE notifications ADD COLUMN IF NOT EXISTS version BIGINT DEFAULT 0;
ALTER TABLE alerts ADD COLUMN IF NOT EXISTS version BIGINT DEFAULT 0;
ALTER TABLE webhooks ADD COLUMN IF NOT EXISTS version BIGINT DEFAULT 0;
ALTER TABLE support_tickets ADD COLUMN IF NOT EXISTS version BIGINT DEFAULT 0;
ALTER TABLE support_messages ADD COLUMN IF NOT EXISTS version BIGINT DEFAULT 0;
ALTER TABLE support_attachments ADD COLUMN IF NOT EXISTS version BIGINT DEFAULT 0;
ALTER TABLE subscriptions ADD COLUMN IF NOT EXISTS version BIGINT DEFAULT 0;
ALTER TABLE payment_gateway_logs ADD COLUMN IF NOT EXISTS version BIGINT DEFAULT 0;
ALTER TABLE subscription_plans ADD COLUMN IF NOT EXISTS version BIGINT DEFAULT 0;
...
ALTER TABLE transfer_orders ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP DEFAULT NOW();
...
ALTER TABLE webhooks ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP DEFAULT NOW();
ALTER TABLE support_messages ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP DEFAULT NOW();
ALTER TABLE support_attachments ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP DEFAULT NOW();
ALTER TABLE subscriptions ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP DEFAULT NOW();
ALTER TABLE payment_gateway_logs ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP DEFAULT NOW();
...
CREATE UNIQUE INDEX IF NOT EXISTS ux_supplier_tenant_email
...
CREATE INDEX IF NOT EXISTS idx_alerts_tenant_dismissed
ON alerts (tenant_id, is_dismissed);
