...
public class CategoryController {
    ...
    public ResponseEntity<Page<CategoryResponse>> list(Pageable pageable) {
        ...
        try {
            ...
            sample.stop(Timer.builder("ims.category.list.latency")
    ...
    public ResponseEntity<CategoryResponse> create(@Valid @RequestBody CategoryRequest request) {
        ...
        try {
            ...
            sample.stop(Timer.builder("ims.category.create.latency")
    ...
    public ResponseEntity<CategoryResponse> get(@PathVariable Long id) {
        ...
        try {
            ...
            sample.stop(Timer.builder("ims.category.get.latency")
    ...
    public ResponseEntity<CategoryResponse> update(
        ...
        try {
            ...
            sample.stop(Timer.builder("ims.category.update.latency")
    ...
    public ResponseEntity<Void> delete(@PathVariable Long id) {
        ...
        try {
            ...
            sample.stop(Timer.builder("ims.category.delete.latency")
