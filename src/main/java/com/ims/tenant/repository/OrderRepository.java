...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    Page<Order> findByTenantIdAndType(
            @Param("tenantId") Long tenantId, @Param("type") OrderType type, Pageable pageable);

    @Query("SELECT o FROM Order o WHERE o.tenantId = :tenantId AND o.supplierId = :supplierId")
    Page<Order> findByTenantIdAndSupplierId(
            @Param("tenantId") Long tenantId, @Param("supplierId") Long supplierId, Pageable pageable);

    @Query("SELECT o FROM Order o WHERE o.tenantId = :tenantId AND o.customerId = :customerId")
    Page<Order> findByTenantIdAndCustomerId(
            @Param("tenantId") Long tenantId, @Param("customerId") Long customerId, Pageable pageable);
