...
public class CustomerController {
  ...
  public @NonNull ResponseEntity<Page<com.ims.dto.response.CustomerResponse>> list(
  ...
  public @NonNull ResponseEntity<com.ims.dto.response.CustomerResponse> create(
