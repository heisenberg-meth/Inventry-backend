...
/**
 * Filter that handles tenant context resolution from headers for public routes. Authoritative
 * tenant resolution for authenticated routes is handled by JwtFilter.
 */
@Slf4j
@Component
