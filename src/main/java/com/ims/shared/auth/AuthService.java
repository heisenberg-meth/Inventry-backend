...
public class AuthService {
    ...
    public LoginResponse login(LoginRequest request) {
        ...
        if ("ROOT".equals(user.getRole()) || "PLATFORM_ADMIN".equals(user.getRole()) || "SUPPORT_ADMIN".equals(user.getRole())) {
            scope = "PLATFORM";
        } else {
            scope = "TENANT";
            if (tenantId != null) {
        ...
        log.info("Login successful: user={} role={} tenant={}", user.getEmail(), user.getRole(), tenantId);
    ...
    public void logout(String token) {
        ...
        redisTemplate.opsForValue().set("jwt:blacklist:" + tokenHash, "revoked", 24, TimeUnit.HOURS);
        log.info("Token blacklisted: {}", tokenHash.substring(0, 8) + "...");
    }
