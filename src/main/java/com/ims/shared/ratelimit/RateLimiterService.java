...
public class RateLimiterService {
  ...
  public RateLimiterService(
    ...
    this.authRateLimitViolations =
        Counter.builder("ratelimit.violations").tag("tier", "auth").register(meterRegistry);
    this.publicRateLimitViolations =
        Counter.builder("ratelimit.violations").tag("tier", "public").register(meterRegistry);
    this.authenticatedRateLimitViolations =
        Counter.builder("ratelimit.violations")
            .tag("tier", "authenticated")
            .register(meterRegistry);
    this.tenantRateLimitViolations =
        Counter.builder("ratelimit.violations").tag("tier", "tenant").register(meterRegistry);
  ...
  /**
   * Gets the current request count in the window. Note: This is not atomic with isAllowed and
