...
public class ProductImportService {
    ...
    public Map<String, Object> importProducts(MultipartFile file, boolean dryRun) {
        ...
        if (tenantId == null) {
            throw new com.ims.shared.exception.TenantContextException("Tenant context missing during import");
        }
        ...
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(file.getInputStream()))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                try {
                    ...
                    Category category = categoryCache.computeIfAbsent(finalCategoryName.toLowerCase(), nameKey -> 
                        categoryRepository.findByNameIgnoreCaseAndTenantId(finalCategoryName, tenantId)
                            .orElseGet(() -> {
                                log.info("Creating new category '{}' for tenant {}", finalCategoryName, tenantId);
